...
public class BlowfishECB {
    ...
    private static BlowfishECB instance = null;
     ...
     * @param bfkey - 密钥 
     */  
    private BlowfishECB(String bfkey) {
        BlowfishInit(bfkey.getBytes());  
    }  


    public static BlowfishECB getInstance(String bfkey){
        if(instance == null){
            synchronized (BlowfishECB.class){
                if(instance == null){
                    instance = new BlowfishECB(bfkey);
                }
            }
        }
        return  instance;
